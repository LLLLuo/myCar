...
const int16 EMAX = 800; //输入误差最大值
const int16 EMIN = 0;//……最小值
const int16 ECMAX = 50;//输入误差变化率最大值
...
//输出P值表
int16 UP0[7] = {90, 92, 95, 98, 104, 110, 115};
int16 UP1[7] = {81, 86, 91, 96, 101, 106, 110};
int16 UP2[7] = {82, 87, 92, 97, 102, 107, 110};
int16 UP3[7] = {85, 90, 95, 100, 105, 110, 115};

int16 UD0[7] = {2800, 3000, 3100, 3200, 3300, 3400, 3500}; 
int16 UD1[7] = {1800, 1800, 1900, 1900, 1900, 2000, 2000}; 
int16 UD2[7] = {1900, 1900, 2000, 2000, 2000, 2100, 2100}; 
int16 UD3[7] = {2000, 2100, 2100, 2100, 2100, 2200, 2200}; 

int16 UFF0[7] = { 80, 82, 84, 90, 100, 110, 120 };
int16 UFF1[7] = { 90, 92, 94, 100, 110, 120, 140 };
int16 UFF2[7] = { 93, 95, 97, 103, 110, 120, 140 }; 
int16 UFF3[7] = { 97, 99, 100, 105, 110, 120, 140 }; 

//int16 UFF0[7] = { 91, 93, 95, 100, 110, 120, 140 };
//int16 UFF1[7] = { 92, 94, 96, 100, 110, 120, 140 };
//int16 UFF2[7] = { 93, 95, 97, 100, 110, 120, 140 }; 
//int16 UFF3[7] = { 96, 97, 98, 100, 110, 120, 140 }; 
